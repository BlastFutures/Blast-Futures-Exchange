...
contract WithdrawSigningTest is Test, EIP712 {
    ...
    constructor() EIP712("RabbitXWithdrawal", "1") {
    }
    ...
    function setUp() public {
        ...
        _sigUtils = new SigUtils(address(_rabbit));

        _token.mint(address(_rabbit), 1e18);
    }
